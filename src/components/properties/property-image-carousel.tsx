  ...
  return (
    <>
      ...
      <div className="relative w-full overflow-hidden lg:hidden" style={{ aspectRatio: "404/264" }}>
        ...
        {/* Type badge */}
        <div className="absolute left-[7px] top-[7px] rounded-full bg-[#00C950] px-[10px] py-[3px]">
          <span className="text-[8px] font-semibold text-white [font-family:var(--font-dm-sans)]">
            {TYPE_LABEL[type]}
          </span>
        </div>
